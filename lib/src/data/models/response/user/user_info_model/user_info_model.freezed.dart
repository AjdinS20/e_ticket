...
mixin _$UserInfoModel {
  String get dodatneInformacije => throw _privateConstructorUsedError;
  List<String> get dozvoljeneAkcije => throw _privateConstructorUsedError;
  String get email => throw _privateConstructorUsedError;
  bool get email_verified => throw _privateConstructorUsedError;
  String get frontendModul => throw _privateConstructorUsedError;
  String get frontendModulNaslov => throw _privateConstructorUsedError;
  String get name => throw _privateConstructorUsedError;
  String get preferred_username => throw _privateConstructorUsedError;
  String get punoIme => throw _privateConstructorUsedError;
...
class _$UserInfoModelImpl implements _UserInfoModel {
  _$UserInfoModelImpl(
      ...
      required this.frontendModul,
      required this.frontendModulNaslov,
      required this.name,
  ...
  @override
  final String frontendModul;
  @override
  final String frontendModulNaslov;
  @override
  final String name;
  @override
  ...
  @override
  String toString() {
    return 'UserInfoModel(dodatneInformacije: $dodatneInformacije, dozvoljeneAkcije: $dozvoljeneAkcije, email: $email, email_verified: $email_verified, frontendModul: $frontendModul, frontendModulNaslov: $frontendModulNaslov, name: $name, preferred_username: $preferred_username, punoIme: $punoIme, role: $role, sub: $sub, ulogaId: $ulogaId)';
  }
...
abstract class _UserInfoModel implements UserInfoModel {
  factory _UserInfoModel(
      {required final String dodatneInformacije,
      required final List<String> dozvoljeneAkcije,
      required final String email,
      required final bool email_verified,
      required final String frontendModul,
      required final String frontendModulNaslov,
  ...
  @override
  String get frontendModul;
  @override
  String get frontendModulNaslov;
  @override
  String get name;
  @override
